...
public class ActiveFirmsFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mapViewButton.setOnClickListener(v -> Eight.dataModel.initialiseActiveFirms(() -> getActivity().getSupportFragmentManager()
                                                                                                       .beginTransaction()
                                                                                                       .replace(R.id.fragmentLayoutId, new MapViewFragment())
