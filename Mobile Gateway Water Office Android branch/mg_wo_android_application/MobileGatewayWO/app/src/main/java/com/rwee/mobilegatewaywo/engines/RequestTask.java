...
public class RequestTask implements ServiceRequestDownloadRunnable.TaskDownloadMethods, ServiceRequestParserRunnable.TaskParsingMethods{

    private WeakReference<GoogleMap> mapWeakReference;
    private ServiceRequest serviceRequest;
    private InputStream inputStream;
    private String currentCollectionName;
    private ServiceRequestDownloadRunnable downloadRequestRunnable;
    private ServiceRequestParserRunnable parseRequestRunnable;
    ...
    void initializeDownloadRequestTask( ThreadManager threadManager, ServiceRequest sr, GoogleMap map ){
        ...
        this.mapWeakReference = new WeakReference<GoogleMap>( map );
    }
    ...
    public ServiceRequestDownloadRunnable getDownloadRequestRunnable() {
        return downloadRequestRunnable;
    }

    public ServiceRequestParserRunnable getParseRequestRunnable() {
