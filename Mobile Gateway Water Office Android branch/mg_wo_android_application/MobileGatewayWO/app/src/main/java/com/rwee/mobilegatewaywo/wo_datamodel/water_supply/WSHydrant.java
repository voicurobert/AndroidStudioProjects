 ...
 */
public class WSHydrant extends AbstractWaterOfficeObject{
    public static final String COLLECTION_NAME = "ws_hydrant";
    public static final String EXTERNAL_NAME = "Hydrant";
    public static final String DATASET_NAME = "water_supply";
    public static final String SPECIFICATION_NAME = "ws_hydrant_spec";

    public String network = "";
    public String state = "";
    public String performance = "";
    public String relationToMain = "";
    ...
    public Map< String, String > fieldsAndValues( ){
        ...
        mapping.put( SmallworldFieldMetadata.PERFORMANCE_FIELD_NAME, performance );
        mapping.put( SmallworldFieldMetadata.RELATION_TO_MAIN_FIELD_NAME, relationToMain );
        return mapping;
    }
    ...
    public BitmapDescriptor getIco( ){
        ...
        if( GlobalHandler.isObjectSelected( this ) ){
            return BitmapDescriptorFactory.fromResource( R.drawable.hydrant_selected );
        }
        return BitmapDescriptorFactory.fromResource( R.drawable.hydrant );
    }
}
