...
import rvo.mobilegateway.engines.SetOnResultAvailableListener;
                            ...
                            new SetOnResultAvailableListener( ){
                                ...
                                public void onResultAvailable( List< HashMap< String, String > > result ) {
                                    if( result.get( 0 ).containsKey( "response_error" ) ){
                                        String message = result.get( 0 ).get( "response_error" );
                                        if( message != null ){
                                            L.t( context, message );
                                        }else{
                                        ...
                                        Intent masterActivity = new Intent( getApplicationContext(), MobileGatewayMapActivity.class );
