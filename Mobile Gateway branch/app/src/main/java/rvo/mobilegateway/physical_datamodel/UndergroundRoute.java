...
public class UndergroundRoute extends AbstractTelcoObject implements IMapListener{
    public static final String COLLECTION_NAME = "underground_route";
    public static final String EXTERNAL_NAME = "Underground Route";
