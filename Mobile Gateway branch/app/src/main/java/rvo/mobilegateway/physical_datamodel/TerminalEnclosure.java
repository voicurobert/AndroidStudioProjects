 ...
 */
public class TerminalEnclosure extends AbstractTelcoObject implements IMapListener{
    public static final String EXTERNAL_NAME = "Terminal Enclosure";
    public static final String COLLECTION_NAME = "mit_terminal_enclosure";
    public static final String SPECIFICATION_NAME = "mit_terminal_enclosure_spec";
    ...
    public boolean equals(Object o) {
        if( o instanceof TerminalEnclosure && ((TerminalEnclosure)o).id == this.id ){
            return true;
        }else{
            return false;
        }
    ...
    public BitmapDescriptor getIco( ){
        ...
        if( MapEngine.isObjectSelected( this ) || ConnectivityEngine.objectIdIsCommonStructureForNetworkConnection( id ) ){
            return BitmapDescriptorFactory.fromResource( R.drawable.selected_terminal_enclosure );
        }
        return BitmapDescriptorFactory.fromResource( R.drawable.terminal_enclosure );
    }
