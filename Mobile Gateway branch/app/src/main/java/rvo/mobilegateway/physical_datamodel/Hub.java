...
public class Hub extends AbstractTelcoObject implements IMapListener{

    public static final String COLLECTION_NAME = "mit_hub";
    public static final String EXTERNAL_NAME = "Hub";
	...
	public String toString() {
        return this.name + this.type + String.valueOf(id) + constructionStatus;
    }

    @Override
    public boolean equals(Object o) {
        if( o instanceof Hub && ((Hub)o).id == this.id ){
            return true;
        }else{
            return false;
        }
    ...
    public BitmapDescriptor getIco( ){
        ...
        if( MapEngine.isObjectSelected( this ) | ConnectivityEngine.objectIdIsCommonStructureForNetworkConnection( id ) ){
            return BitmapDescriptorFactory.fromResource( R.drawable.selected_hub );
        }
        return BitmapDescriptorFactory.fromResource( R.drawable.hub );
    }
